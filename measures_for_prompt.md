...
این جملات به گونه‌ای طراحی شده‌اند که در کنار حفظ ویژگی‌ها و جزئیات معانی اصلی، برای انواع متون و زمینه‌ها کاربرد داشته باشند.
...
متن معیار ورودی منفی: "شرکت یا شهروند، خانواده فقط سلول مصرفی کوچک"
...
جمله عمومی: "گسترش کشاورزی صنعتی با هدف افزایش بهره‌وری ممکن است به فراموشی اصول توسعه پایدار و مراقبت از منابع طبیعی منجر شود."
...
معیار منفی: *توسعه تکاثری، اجیر شدن، بیگاری.*
...
معیار منفی: محور تجمع و شور و نشاط اجتماعی، حضور در بازار و تولید ثروت
...
معیار مثبت: توجه به ساختارهای تشخیص و درمان بیماری توسط قشر متخصص 
...
معیار ١٠٥
معیار مثبت: 
در نظام تولید، توزیع و مصرف، اقامه قسط به معنای تحقق عدالت و احسان از طریق ایجاد تعادل و انصاف به‌خصوص در فضای اقتصادی و اجتماعی بسیار حائز اهمیت است.

معیار منفی: 
به اجاره بالای فروشگاه‌ها و توجه صرف به بهره‌وری در نظام تولید، توزیع و مصرف، اتلاف وقت افراد تحت عنوان صرفه‌جویی در زمان خرید، فربه‌سازی نظام تک محصولی شهرها به منظور حذف روابط نابازار میان خریدار و فروشنده، و تکیه بر نفع فردی در گزارش خرید به عنوان مشکلاتی که به عدالت اقتصادی آسیب می‌زنند، می‌توان اشاره کرد.
...
معیار ١٠٧
متن معیار ورودی مثبت: "مردم باید دارای بصیرتی شفاف نسبت به تمایز جامعه ایمانی از جامعه دنیاپرستی داشته باشند."

جمله عمومی مثبت: "شایسته است افراد توانایی درک و تشخیص واضحی از تفاوت‌های بین جوامع ایمانی و دنیوی داشته باشند."

متن معیار ورودی منفی: "هویت اصلی از تعصبات قبیلگی و باستانی یا دنیاپرستی مدرن گرفته شود."

جمله عمومی منفی: "نادرست است که هویت فرد به‌طور عمده تحت تأثیر تعصبات قبیلگی، سنت‌های باستانی یا گرایش‌های مدرن دنیاطلبانه قرار گیرد."
...
معیار ١٠٩
 معیار مثبت:
* سوق المسلمین به سمت مساجد: تقویت ارتباط اجتماعی و معنوی جامعه با تسهیل دسترسی به مراکز عبادی و روحانی.

 معیار منفی:
* افزایش کمیت تولید محصولات کشاورزی از طریق سرمایه‌گذاری و کشاورزی متمرکز: ایجاد وابستگی به سیستم‌های تولید متمرکز که ممکن است منجر به کاهش تنوع زیستی و بهره‌برداری ناپایدار از منابع طبیعی شود.  
* تصویر اقتصادی مبتنی بر کشاورزی صنعتی در تولید یا واردات محصولات کشاورزی: اولویت دادن به صرفه‌جویی‌های اقتصادی به جای پایداری زیست‌محیطی و اجتماعی که می‌تواند به آسیب‌های بلندمدت به اکوسیستم منجر شود.  
* تسهیل ورود سرمایه‌دار به بخش کشاورزی برای صنعتی‌سازی: بهره‌برداری از منابع طبیعی و کارگران به نفع منافع شخصی که می‌تواند به هزینه‌های اجتماعی و اقتصادی منجر شود.  
* روش‌های دولتی یا پیمانکاران خصوصی در کاشت محصولات: نگرانی از تأثیرات منفی بر حقوق و وضعیت معیشتی کارگران و نیز خطرات ناشی از تمرکز قدرت در دستان برخی افراد یا نهادها.  
* گسترش کشاورزی صنعتی با هدف افزایش صرفه اقتصادی: ریسک بهره‌کشی از منابع طبیعی و اجتماعی بدون توجه به پایداری و تأثیرات زیست‌محیطی آن.  
* محوریت گونه‌های غیر مثمر: دور شدن از کشاورزی پایدار و تأکید بر گونه‌هایی که ممکن است از نظر اقتصادی به‌صرفه نباشند.  
* روش مشابه‌سازی در تولید: فقدان نوآوری و تفکر خلاق که می‌تواند به کاهش کیفیت و تنوع محصولات منجر شود.  
* حمایت از تولیدکنندگان بزرگ و تمرکز در میادین میوه و سبزیجات: ایجاد نابرابری در بازار و برهم زدن تعادل میان تولیدکنندگان کوچک و بزرگ.  
* توزیع متمرکز و تجارت روزمره: معضل عدم دسترسی برابر مصرف‌کنندگان به محصولات و محدود کردن گزینه‌های انتخابی آنها.  
* وجود کارخانه‌های بزرگ و متمرکز: خطرات ناشی از آلودگی محیط‌زیست و تمرکز ثروت در دستان چند نفر که ممکن است بر معیشت جامعه تأثیر منفی بگذارد.  
* مزیت‌محور بودن: تمرکز بر منافع کوتاه‌مدت به جای توجه به توسعه پایدار و توانمندسازی جامعه.  
* توسعه تکاثری و استخدام بیگاری: نقض حقوق کارگران و عدم توجه به نیازهای انسانی در فرآیند تولید.  
...
جمله عمومی: "تلقی مثبت از تلخیص و ارائه‌ مطالب به گونه‌ای که توانمندی‌ها و جنبه‌های موثر در ارتباطات را به نمایش بگذارد."

متن معیار ورودی منفی: 

"افزایش کمیت تولید محصولات از طریق سرمایه گذاری و کشاورزی متمرکز. معیار قرار گرفتن صرفه اقتصادی بر پایه کشاورزی صنعتی در تولید یا واردات محصولات کشاورزی. هموار کردن ورود سرمایه دار به بخش کشاورزی به منظور ورود تکنولوژی و صنعتی سازی کشاورزی برای افزایش صرفه اقتصادی. کاشت با تصرف دولتی یا پیمانکار خصوصی. گسترش کشاورزی متمرکز صنعتی به منظور افزایش صرفه اقتصادی از طریق بهره‌کشی از منابع تا حد امکان یا با توجه به توسعه پایدار. محوریت گونه‌های غیر مثمر. مشابه سازی. میادین میوه و تربه بار. توزیع متمرکز. حامی تولید کننده‌های بزرگ. بازار روز و رانت فضا. کارخانه‌های متمرکز و بزرگ. مزیت محور. توسعه تکاثری، اجیر شدن، بیگاری."

جمله عمومی: "افزایش تمرکز بر تولید صنعتی محصولات کشاورزی به عنوان یک رویکرد اقتصادی، که ممکن است منجر به وابستگی به منابع محدود و نادیده گرفتن تنوع زیستی، همچنین به خطر انداختن حقوق کارگران و تأثیرات اجتماعی و محیطی نامطلوب شود."
...
معیار ١١٣
خروجی مثبت: "فردی است که با نگرش ایثارگرانه و مشفقانه به جامعه مؤمنین خدمت می‌کند و در عین حال با رویکردی سخت‌گیرانه به تمدن مادی، تلاش می‌کند تعادل و موازنه‌ای جهانی را برقرار سازد."

خروجی منفی: "فردی که در عملکرد خود به وضوح تحت تاثیر انگیزه سود قرار دارد و سایر انگیزه‌های انسانی را در ارزیابی‌های خود نادیده می‌گیرد، به نحوی که به عنوان انسانی صرفاً اقتصادی شناخته می‌شود."
...
معیار ١١٥
متن معیار مثبت: "تعامل موثر و مفید با حیوانات خانگی می‌تواند به تقویت روابط خانوادگی و ایجاد فضای دوستانه در خانه کمک کند."

متن معیار منفی: "استفاده از حیوان خانگی به عنوان تنها مونس انسان ممکن است باعث کاهش ارتباطات اجتماعی و وابستگی به روابط خانوادگی گردد."

معیار ١١٦
خروجی برای معیار مثبت:  
ایجاد ساختاری شفاف و مبتنی بر اعتماد که مشارکت مردم را تسهیل کرده و به ارتقای تفکر خلاق و ابتکار آنان کمک می‌کند، با ایجاد انگیزه برای درک بهتر مسائل و فعال‌سازی پتانسیل جوانان و سایر افراد.

خروجی برای معیار منفی:  
سلطه مدیران یا نخبگان که منجر به محدودیت در مشارکت واقعی مردم در فرآیند تصمیم‌گیری می‌شود، به طوری که تصمیمات از بالا به پایین اجرا می‌شوند و تنها انتخاب مجریان در این روند مشاهده می‌شود.

معیار ١١٧
خروجی برای معیار مثبت:  
"ارتقا و شکل‌گیری مشارکت مردمی در فرآیندهای تصمیم‌سازی حقیقی، به‌گونه‌ای که افراد در کنار هم و در میان جامعه، نقش فعالی در شکل‌دهی و هدایت تصمیمات داشته باشند."

خروجی برای معیار منفی:  
"مشارکت مردمی در تصمیمات به‌صورت فشار از بالا، جایی که افراد تنها در اجرای تصمیمات منتخب یا قانونی عمل می‌کنند، و امکان تأثیرگذاری مستقیم آنها محدود به رأی‌گیری‌های غیرمؤثر یا رفراندوم‌هاست."
...
معیار ١٢٠
معیار مثبت (مثمرکار) : 
تحقیقات و فعالیت‌های اقتصادی مؤثر به تقویت تولید و بهره‌وری در بخش‌های مختلف می‌انجامد.

---

معیار منفی: 
ظهور خطرات ناشی از تمرکز تولیدات کشاورزی و صنعتی بر پایه‌های اقتصادی کوتاه‌مدت، که ممکن است به تضعیف منابع طبیعی و تنوع زیستی منجر شود.

معیار ١٢١
جملات عمومی برای معیارهای مثبت و منفی:

معیار مثبت: توزیع انبوه شبکه‌ای غیرمتمرکز 
این معیار به توزیع گسترده و غیرمتمرکز منابع و خدمات اشاره دارد که به ارتقاء همکاری و تعامل در بخش‌های مختلف کمک می‌کند و از تمرکز بیش از حد در تصمیم‌گیری‌ها جلوگیری می‌کند.

معیار منفی: افزایش کمیت تولید محصولات از طریق سرمایه‌گذاری و کشاورزی متمرکز 
این جنبه تحت تأثیر قرار دادن کشاورزی از طریق تمرکز بر سرمایه‌گذاری و افزایش کمیّت تولید است که می‌تواند به تداخل در تنوع محصولات، کاهش کیفیت و نادیده گرفتن پایداری محیط‌زیستی منجر شود، همچنین می‌تواند با ورود تکنولوژی و صنعتی‌سازی تأثیر منفی بر روی کشاورزی محلی داشته باشد.

معیار منفی: محوریت گونه‌های غیر مثمر و مشابه‌سازی 
...
معیار منفی: توزیع متمرکز و حمایت از تولیدکنندگان بزرگ 
این جنبه به توزیع مرکزگرا و حمایت از تولیدکنندگان بزرگ اشاره می‌کند که ممکن است به نادیده‌گیری تولیدکنندگان کوچک، کاهش رقابت و ایجاد فضای نامناسب برای بازارهای محلی منجر شود. 

معیار منفی: توسعه کشاورزی متمرکز صنعتی 
این معیار به ترویج کشاورزی مرکزی و صنعتی برای افزایش بهره‌وری و سرمایه‌گذاری اشاره دارد که می‌تواند به بهره‌کشی از منابع و ایجاد مشکلات زیست‌محیطی بر اساس سعی در افزایش صرفه اقتصادی منجر شود. 

با توجه به این الگوها، جملات عمومی می‌توانند در زمینه‌های مختلف به کار گرفته شوند و مفاهیم مورد نظر را به خوبی منتقل کنند.

معیار ١٢٢
معیار مثبت: 
فعل حکومتی باید آگاهی‌افزا و اختیاردهنده باشد تا به جامعه کمک کند اهداف اسلام را محقق سازد و با زنده نگه داشتن تفکر و اندیشه در سایه معرفت، مردم را در تشخیص حق از باطل یاری کند.

معیار منفی: 
وجود سلطه مدیران یا نخبگان می‌تواند موجب محدودیت مشارکت مردمی در اجرای تصمیمات از بالا به پایین شود و تنها به انتخاب مجری محدود گردد.
...
معیار ١٢٥
معیار مثبت:
حفظ تنوع زیستی و تلاش برای بهبود قاعده‌مند و با قابلیت تکثیر ذخایر ژنتیک در جامعه، به بهبود اکوسیستم و پایداری محیط زیست کمک می‌کند و به ایجاد توازن در منابع طبیعی می‌انجامد.

معیار منفی:
مشابه‌سازی و بهینه‌سازی ژنتیک با هدف تسلط بر چرخه بازار کشاورزی و تضمین سود سرمایه، می‌تواند به ریشه‌کنی تنوع زیستی و ناپایداری در منابع غذایی منجر شود و به عواقب منفی برای کشاورزان و محیط زیست بینجامد.

معیار ١٢٦
خروجی مورد انتظار:

1. معیار مثبت:"تلاش برای برقراری تعادل میان انسان و طبیعت، نشانه‌ای از شناخت عمیق ما نسبت به وابستگی متقابل این دو و اهمیت حفظ سلامت سیاره است."
   
2. معیار منفی:"هرگونه بر هم زدن تعادل میان انسان و طبیعت با خودخواهی و قدرت‌طلبی، خطر جدی بر سلامت محیط زیست و آینده بشریت به همراه دارد."

معیار ١٢٧
جمله مثبت: "فرهنگ غنی و تنوع هویتی مردم منطقه با حفظ استقلال معیشت‌شان از تأثیرات گردشگران، تأکید بر ارزش‌های محلی و ارتباط با طبیعت را تقویت می‌کند."

جمله منفی: "معیار اقتصادی بودن مسأله توریسم ممکن است موجب تمرکز بیش از حد بر سود مالی و فراموشی جنبه‌های فرهنگی و اجتماعی مرتبط با جوامع محلی شود."
